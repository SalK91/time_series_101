...
| **Exponential Weighted Moving Average** | Uses an exponentially weighted average of past squared volatilities.                                                             $\tilde{\sigma}^2_{t+1} = \frac{ {\sum} _{j=0} ^{m-1} (\beta^j \hat{\sigma}^2_{t-j})}{ {\sum} _{j=0} ^{m-1} \beta^j}$                                                                                                                                                        | $\tilde{\sigma}^2_{t+1} = \frac{{\sum} _{j=0} ^{m-1} \hat{\sigma} _{t-j} ^2}{{\sum} _{j=0} ^{m-1} \beta^j}$                                                                              |
